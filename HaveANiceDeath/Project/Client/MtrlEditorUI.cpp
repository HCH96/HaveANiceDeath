...
void MtrlEditorUI::render_update()
{
	...
	{
		ImGui::Text("INT_0"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##INT_0_Desc", m_INT_Desc[0].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputInt("##INT_0_DATA", &m_IntArr[0]);
		ImGui::Text("INT_1"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##INT_1_Desc", m_INT_Desc[1].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputInt("##INT_1_DATA", &m_IntArr[1]);
		ImGui::Text("INT_2"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##INT_2_Desc", m_INT_Desc[2].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputInt("##INT_2_DATA", &m_IntArr[2]);
		ImGui::Text("INT_3"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##INT_3_Desc", m_INT_Desc[3].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputInt("##INT_3_DATA", &m_IntArr[3]);
	...
	{
		ImGui::Text("FLOAT_0"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##FLOAT_0_Desc", m_FLOAT_Desc[0].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputFloat("##FLOAT_0_DATA", &m_FloatArr[0]);
		ImGui::Text("FLOAT_1"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##FLOAT_1_Desc", m_FLOAT_Desc[1].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputFloat("##FLOAT_1_DATA", &m_FloatArr[1]);
		ImGui::Text("FLOAT_2"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##FLOAT_2_Desc", m_FLOAT_Desc[2].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputFloat("##FLOAT_2_DATA", &m_FloatArr[2]);
		ImGui::Text("FLOAT_3"); ImGui::SameLine(100); ImGui::SetNextItemWidth(m_DescSize); ImGui::InputText("##FLOAT_3_Desc", m_FLOAT_Desc[3].data(), 32,ImGuiInputTextFlags_ReadOnly); ImGui::SameLine(m_DescSize + 120); ImGui::SetNextItemWidth(m_InputSize); ImGui::InputFloat("##FLOAT_3_DATA", &m_FloatArr[3]);
	...
	{
		ImGui::Text("VEC4_0"); ImGui::SameLine(100); ImGui::InputText("##VEC4_0_Desc", m_V4_Desc[0].data(), 32, ImGuiInputTextFlags_ReadOnly);
		ImGui::Text("Data"); ImGui::SameLine(100); ImGui::InputFloat4("##VEC4_0_DATA", m_V4Arr[0]);
		ImGui::Spacing(); ImGui::Spacing();

		ImGui::Text("VEC4_1"); ImGui::SameLine(100); ImGui::InputText("##VEC4_1_Desc", m_V4_Desc[1].data(), 32, ImGuiInputTextFlags_ReadOnly);
		ImGui::Text("Data"); ImGui::SameLine(100); ImGui::InputFloat4("##VEC4_1_DATA", m_V4Arr[1]);
		ImGui::Spacing(); ImGui::Spacing();

		ImGui::Text("VEC4_2"); ImGui::SameLine(100); ImGui::InputText("##VEC4_2_Desc", m_V4_Desc[2].data(), 32, ImGuiInputTextFlags_ReadOnly);
		ImGui::Text("Data"); ImGui::SameLine(100); ImGui::InputFloat4("##VEC4_2_DATA", m_V4Arr[2]);
		ImGui::Spacing(); ImGui::Spacing();

		ImGui::Text("VEC4_3"); ImGui::SameLine(100); ImGui::InputText("##VEC4_3_Desc", m_V4_Desc[3].data(), 32, ImGuiInputTextFlags_ReadOnly);
